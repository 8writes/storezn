...
// Shared by both ways a store gets created: the public vendor signup
// below, and an existing vendor adding another one (POST
// /api/v1/vendor/stores, capped at 3 per vendor - see that route).
...
export const createStoreSchema = storeFieldsSchema;

// Public self-signup - includes a required terms-of-service acceptance,
// since the vendor themselves is the one clicking it.
export const vendorSignupSchema = storeFieldsSchema.extend({
  vendor: z.object({
