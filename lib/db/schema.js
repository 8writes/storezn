...
export const products = pgTable(
  "products",
  {
    ...
    // Discount display only - `price` is always the real, charged amount
    // (cart/checkout/orders never read this column). When set higher than
    // price, the storefront shows it struck through next to the real
    // price as a "was" price. Null means no discount is being shown.
