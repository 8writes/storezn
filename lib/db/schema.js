...
export const stores = pgTable(
  "stores",
  {
    ...
    // Vendor's own opt-in (default off) into the cross-store Storezn
    // marketplace (app/stores/page.js) - their products only show up
    // there once this is true, on top of the usual isStoreLive checks
    // (see lib/marketplace.js's getMarketplaceProducts). Clicking a
    // product there always hands off to the vendor's own storefront to
    // actually buy - the marketplace is discovery-only, not a shared
    // cart/checkout.
