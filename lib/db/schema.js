...
export const cartItems = pgTable(
  ...
  (table) => ({
    ...
    cartBaseProductUnique: uniqueIndex("uq_cart_items_cart_product_base").on(table.cartId, table.productId).where(isNull(table.variantId)),
    cartVariantUnique: uniqueIndex("uq_cart_items_cart_variant").on(table.cartId, table.productId, table.variantId).where(isNotNull(table.variantId)),
  }),
);
