...
// Lightweight API request monitoring. Stores endpoint/status/duration,
// not request bodies or auth headers, so it can be used for operations
// without leaking customer/vendor secrets into the admin UI.
