...
export const products = pgTable(
  "products",
  {
    ...
    sku: text("sku"),
    description: text("description"),
    // Free-text sizing chart (plain multi-line, rendered as-is on the
    // product page behind a "Size guide" toggle) - optional, mostly for
    // apparel/footwear. Null/empty means no size-guide link is shown.
