const SERVICE_DEFINITIONS = [
  ...
  { id: "payments", name: "Payment processing", description: "Payment confirmation webhooks", matches: (source) => source === "paystack.webhook" },
  ...
  { id: "pos", name: "Point of sale", description: "Register sales and offline synchronization", matches: (source) => source.startsWith("vendor.pos.") },
