...
// Re-exported so callers that only need the key predicate (and tests)
// don't have to know which provider is configured.
export { keyBelongsToUser, UPLOAD_PURPOSES } from "./keyOwnership.js";
