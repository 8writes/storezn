  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start sm:items-center justify-center overflow-y-auto p-4 py-8">
      ...
      <div className="relative bg-white rounded-sm shadow-xl w-full max-w-sm p-6 space-y-4 my-auto">
        <div>
          <span className="inline-block text-[11px] font-bold uppercase tracking-wide text-amber-700 bg-amber-100 px-2 py-0.5 rounded-xs mb-2">
            Important Notice
          </span>
          <h2 className="font-semibold text-xl text-slate-900">You&apos;re now on {storeName}&apos;s store</h2>
          <p className="text-base text-slate-800 mt-1.5 leading-relaxed">
