...
import { products, productVariants, stores } from "../../../../../../../../../../lib/db/schema.js";
...
export async function PATCH(req, { params }) {
  ...
  const [updated] = await db.update(productVariants).set(result.data).where(eq(productVariants.id, variantId)).returning();
