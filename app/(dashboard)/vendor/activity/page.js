  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-end gap-3 flex-wrap rounded-sm border border-slate-300 bg-slate-100 p-3">
        ...
        >
          <label htmlFor="activity-search" className="block text-sm font-semibold text-slate-900 mb-1">Search details</label>
          <div className="relative">
            ...
            <input
              ...
              className="w-full h-10 pl-9 pr-10 rounded-sm border border-slate-400 bg-surface text-sm text-slate-900 placeholder:text-slate-500 outline-none focus:border-brand-600 focus:ring-2 focus:ring-brand-100"
            />
            <button type="submit" title="Search activity" aria-label="Search activity" className="absolute right-1 top-1/2 -translate-y-1/2 p-2 text-slate-700 hover:text-brand-700 cursor-pointer">
              <Search size={16} />
            </button>
          </div>
        </form>
        ...
        <button
          ...
          className={`h-10 px-3 border rounded-sm text-sm font-semibold inline-flex items-center gap-2 cursor-pointer ${flaggedOnly ? "border-amber-700 bg-amber-100 text-amber-800" : "border-slate-400 bg-surface text-slate-900 hover:bg-slate-50"}`}
        >
